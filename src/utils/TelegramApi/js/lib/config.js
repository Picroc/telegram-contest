...
Config.Schema.MTProto = {
	constructors: [
		...
		{ id: '812830625', predicate: 'gzip_packed', params: [{ name: 'packed_data', type: 'bytes' }], type: 'Object' },
		{
			id: '1658238041',
			predicate: 'msgs_ack',
		...
		{ id: '-161422892', predicate: 'destroy_auth_key_ok', params: [], type: 'DestroyAuthKeyRes' },
		{ id: '178201177', predicate: 'destroy_auth_key_none', params: [], type: 'DestroyAuthKeyRes' },
		{ id: '-368010477', predicate: 'destroy_auth_key_fail', params: [], type: 'DestroyAuthKeyRes' },
		{
			id: '-501201412',
	...
	methods: [
		{ id: '1615239032', method: 'req_pq', params: [{ name: 'nonce', type: 'int128' }], type: 'ResPQ' },
		{ id: '-1099002127', method: 'req_pq_multi', params: [{ name: 'nonce', type: 'int128' }], type: 'ResPQ' },
		{
			id: '-686627650',
		...
		{ id: '-1188971260', method: 'get_future_salts', params: [{ name: 'num', type: 'int' }], type: 'FutureSalts' },
		{ id: '2059302892', method: 'ping', params: [{ name: 'ping_id', type: 'long' }], type: 'Pong' },
		{
			id: '-213746804',
		...
		{ id: '-784117408', method: 'destroy_auth_key', params: [], type: 'DestroyAuthKeyRes' },
		{
			id: '-414113498',
...
Config.Schema.API = {
	constructors: [
		...
		{ id: '396093539', predicate: 'inputPeerChat', params: [{ name: 'chat_id', type: 'int' }], type: 'InputPeer' },
		{ id: '-1182234929', predicate: 'inputUserEmpty', params: [], type: 'InputUser' },
		{ id: '-138301121', predicate: 'inputUserSelf', params: [], type: 'InputUser' },
		{
			id: '-208488460',
		...
		{ id: '480546647', predicate: 'inputChatPhotoEmpty', params: [], type: 'InputChatPhoto' },
		{
			id: '-1837345356',
		...
		{ id: '-1649296275', predicate: 'peerUser', params: [{ name: 'user_id', type: 'int' }], type: 'Peer' },
		{ id: '-1160714821', predicate: 'peerChat', params: [{ name: 'chat_id', type: 'int' }], type: 'Peer' },
		{ id: '-1432995067', predicate: 'storage.fileUnknown', params: [], type: 'storage.FileType' },
		...
		{ id: '172975040', predicate: 'storage.filePng', params: [], type: 'storage.FileType' },
		{ id: '-1373745011', predicate: 'storage.filePdf', params: [], type: 'storage.FileType' },
		{ id: '1384777335', predicate: 'storage.fileMp3', params: [], type: 'storage.FileType' },
		{ id: '1258941372', predicate: 'storage.fileMov', params: [], type: 'storage.FileType' },
		{ id: '-1278304028', predicate: 'storage.fileMp4', params: [], type: 'storage.FileType' },
		{ id: '276907596', predicate: 'storage.fileWebp', params: [], type: 'storage.FileType' },
		{ id: '537022650', predicate: 'userEmpty', params: [{ name: 'id', type: 'int' }], type: 'User' },
		{ id: '1326562017', predicate: 'userProfilePhotoEmpty', params: [], type: 'UserProfilePhoto' },
		{
			id: '-321430132',
		...
		{ id: '-1683826688', predicate: 'chatEmpty', params: [{ name: 'id', type: 'int' }], type: 'Chat' },
		{
			id: '1004149726',
			predicate: 'chat',
			params: [
		...
		{ id: '-1618676578', predicate: 'messageMediaUnsupported', params: [], type: 'MessageMedia' },
		{ id: '-1230047312', predicate: 'messageActionEmpty', params: [], type: 'MessageAction' },
		{
			id: '-1503425638',
		...
		{ id: '-1780220945', predicate: 'messageActionChatDeletePhoto', params: [], type: 'MessageAction' },
		{
			id: '1217033015',
		...
		{ id: '590459437', predicate: 'photoEmpty', params: [{ name: 'id', type: 'long' }], type: 'Photo' },
		{
			id: '-797637467',
			predicate: 'photo',
			params: [
		...
		{ id: '236446268', predicate: 'photoSizeEmpty', params: [{ name: 'type', type: 'string' }], type: 'PhotoSize' },
		{
			id: '2009052699',
			predicate: 'photoSize',
			params: [
		...
		{ id: '1251338318', predicate: 'inputNotifyChats', params: [], type: 'InputNotifyPeer' },
		{
			id: '-1673717362',
		...
		{ id: '505595789', predicate: 'inputReportReasonViolence', params: [], type: 'ReportReason' },
		{ id: '777640226', predicate: 'inputReportReasonPornography', params: [], type: 'ReportReason' },
		{ id: '-1376497949', predicate: 'inputReportReasonChildAbuse', params: [], type: 'ReportReason' },
		{
			id: '-512463606',
		...
		{ id: '-1219778094', predicate: 'contacts.contactsNotModified', params: [], type: 'contacts.Contacts' },
		{
			id: '-353862078',
		...
		{ id: '1474492012', predicate: 'inputMessagesFilterEmpty', params: [], type: 'MessagesFilter' },
		{ id: '-1777752804', predicate: 'inputMessagesFilterPhotos', params: [], type: 'MessagesFilter' },
		{ id: '-1614803355', predicate: 'inputMessagesFilterVideo', params: [], type: 'MessagesFilter' },
		{ id: '1458172132', predicate: 'inputMessagesFilterPhotoVideo', params: [], type: 'MessagesFilter' },
		{ id: '-1629621880', predicate: 'inputMessagesFilterDocument', params: [], type: 'MessagesFilter' },
		{ id: '2129714567', predicate: 'inputMessagesFilterUrl', params: [], type: 'MessagesFilter' },
		{ id: '-3644025', predicate: 'inputMessagesFilterGif', params: [], type: 'MessagesFilter' },
		{
			id: '522914557',
		...
		{ id: '406307684', predicate: 'inputEncryptedFileEmpty', params: [], type: 'InputEncryptedFile' },
		{
			id: '1690108678',
		...
		{ id: '922273905', predicate: 'documentEmpty', params: [{ name: 'id', type: 'long' }], type: 'Document' },
		{
			id: '-1683841855',
			predicate: 'document',
			params: [
		...
		{ id: '-1613493288', predicate: 'notifyPeer', params: [{ name: 'peer', type: 'Peer' }], type: 'NotifyPeer' },
		{ id: '-1261946036', predicate: 'notifyUsers', params: [], type: 'NotifyPeer' },
		{ id: '-1073230141', predicate: 'notifyChats', params: [], type: 'NotifyPeer' },
		{
			id: '-2131957734',
		...
		{ id: '381645902', predicate: 'sendMessageTypingAction', params: [], type: 'SendMessageAction' },
		{ id: '-44119819', predicate: 'sendMessageCancelAction', params: [], type: 'SendMessageAction' },
		{ id: '-1584933265', predicate: 'sendMessageRecordVideoAction', params: [], type: 'SendMessageAction' },
		{
			id: '-378127636',
		...
		{ id: '-718310409', predicate: 'sendMessageRecordAudioAction', params: [], type: 'SendMessageAction' },
		{
			id: '-212740181',
		...
		{ id: '393186209', predicate: 'sendMessageGeoLocationAction', params: [], type: 'SendMessageAction' },
		{ id: '1653390447', predicate: 'sendMessageChooseContactAction', params: [], type: 'SendMessageAction' },
		{
			id: '-1290580579',
		...
		{ id: '129960444', predicate: 'userStatusLastWeek', params: [], type: 'UserStatus' },
		...
		{ id: '1335282456', predicate: 'inputPrivacyKeyStatusTimestamp', params: [], type: 'InputPrivacyKey' },
		{ id: '-1137792208', predicate: 'privacyKeyStatusTimestamp', params: [], type: 'PrivacyKey' },
		{ id: '218751099', predicate: 'inputPrivacyValueAllowContacts', params: [], type: 'InputPrivacyRule' },
		{ id: '407582158', predicate: 'inputPrivacyValueAllowAll', params: [], type: 'InputPrivacyRule' },
		{
			id: '320652927',
		...
		{ id: '195371015', predicate: 'inputPrivacyValueDisallowContacts', params: [], type: 'InputPrivacyRule' },
		{ id: '-697604407', predicate: 'inputPrivacyValueDisallowAll', params: [], type: 'InputPrivacyRule' },
		{
			id: '-1877932953',
		...
		{ id: '-123988', predicate: 'privacyValueAllowContacts', params: [], type: 'PrivacyRule' },
		...
		{ id: '-125240806', predicate: 'privacyValueDisallowContacts', params: [], type: 'PrivacyRule' },
		{ id: '-1955338397', predicate: 'privacyValueDisallowAll', params: [], type: 'PrivacyRule' },
		{
			id: '209668535',
		...
		{ id: '297109817', predicate: 'documentAttributeAnimated', params: [], type: 'DocumentAttribute' },
		{
			id: '1662637586',
		...
		{ id: '-244016606', predicate: 'messages.stickersNotModified', params: [], type: 'messages.Stickers' },
		{
			id: '-463889475',
		...
		{ id: '-395967805', predicate: 'messages.allStickersNotModified', params: [], type: 'messages.AllStickers' },
		{
			id: '-302170017',
		...
		{ id: '-350980120', predicate: 'webPageEmpty', params: [{ name: 'id', type: 'long' }], type: 'WebPage' },
		{
			id: '-981018084',
		...
		},
		{
			...
			params: [
				...
				{ name: 'documents', type: 'flags.11?Vector<Document>' },
		...
		{ id: '-4838507', predicate: 'inputStickerSetEmpty', params: [], type: 'InputStickerSet' },
		{
			id: '-1645763991',
		...
		},
		{
			...
			params: [
				...
				{ name: 'thumb', type: 'flags.4?PhotoSize' },
		...
		{ id: '-1109531342', predicate: 'peerChannel', params: [{ name: 'channel_id', type: 'int' }], type: 'Peer' },
		{
			id: '548253432',
		...
		},
		{
			...
			params: [
				...
				{ name: 'can_view_stats', type: 'flags.12?true' },
		...
		{ id: '-1798033689', predicate: 'channelMessagesFilterEmpty', params: [], type: 'ChannelMessagesFilter' },
		{
			id: '-847783593',
		...
		{ id: '-566281095', predicate: 'channelParticipantsRecent', params: [], type: 'ChannelParticipantsFilter' },
		{ id: '-1268741783', predicate: 'channelParticipantsAdmins', params: [], type: 'ChannelParticipantsFilter' },
		{
			id: '-1548400251',
		...
		{ id: '-1328445861', predicate: 'channelParticipantsBots', params: [], type: 'ChannelParticipantsFilter' },
		{
			id: '2013922064',
		...
		{ id: '-402498398', predicate: 'messages.savedGifsNotModified', params: [], type: 'messages.SavedGifs' },
		{
			id: '772213157',
		...
		{ id: '1358283666', predicate: 'inputMessagesFilterVoice', params: [], type: 'MessagesFilter' },
		{ id: '928101534', predicate: 'inputMessagesFilterMusic', params: [], type: 'MessagesFilter' },
		{ id: '-1107622874', predicate: 'inputPrivacyKeyChatInvite', params: [], type: 'InputPrivacyKey' },
		...
		{ id: '-1799538451', predicate: 'messageActionPinMessage', params: [], type: 'MessageAction' },
		{ id: '1923290508', predicate: 'auth.codeTypeSms', params: [], type: 'auth.CodeType' },
		{ id: '1948046307', predicate: 'auth.codeTypeCall', params: [], type: 'auth.CodeType' },
		{ id: '577556219', predicate: 'auth.codeTypeFlashCall', params: [], type: 'auth.CodeType' },
		{
			id: '1035688326',
		...
		{ id: '-1419371685', predicate: 'topPeerCategoryBotsPM', params: [], type: 'TopPeerCategory' },
		{ id: '344356834', predicate: 'topPeerCategoryBotsInline', params: [], type: 'TopPeerCategory' },
		{ id: '104314861', predicate: 'topPeerCategoryCorrespondents', params: [], type: 'TopPeerCategory' },
		{ id: '-1122524854', predicate: 'topPeerCategoryGroups', params: [], type: 'TopPeerCategory' },
		{ id: '371037736', predicate: 'topPeerCategoryChannels', params: [], type: 'TopPeerCategory' },
		{
			id: '-75283823',
		...
		{ id: '-567906571', predicate: 'contacts.topPeersNotModified', params: [], type: 'contacts.TopPeers' },
		{
			id: '1891070632',
		...
		{ id: '975236280', predicate: 'inputMessagesFilterChatPhotos', params: [], type: 'MessagesFilter' },
		{
			id: '634833351',
		...
		{ id: '-1615153660', predicate: 'messageActionHistoryClear', params: [], type: 'MessageAction' },
		{
			id: '82699215',
		...
		{ id: '861169551', predicate: 'updatePtsChanged', params: [], type: 'Update' },
		{
			id: '-440664550',
		...
		{ id: '-1744710921', predicate: 'documentAttributeHasStickers', params: [], type: 'DocumentAttribute' },
		{
			id: '1251549527',
		...
		{ id: '1950782688', predicate: 'textPlain', params: [{ name: 'text', type: 'string' }], type: 'RichText' },
		{ id: '1730456516', predicate: 'textBold', params: [{ name: 'text', type: 'RichText' }], type: 'RichText' },
		{ id: '-653089380', predicate: 'textItalic', params: [{ name: 'text', type: 'RichText' }], type: 'RichText' },
		{
			id: '-1054465340',
		...
		{ id: '-1678197867', predicate: 'textStrike', params: [{ name: 'text', type: 'RichText' }], type: 'RichText' },
		{ id: '1816074681', predicate: 'textFixed', params: [{ name: 'text', type: 'RichText' }], type: 'RichText' },
		{
			id: '1009288385',
			predicate: 'textUrl',
			params: [
		...
		{ id: '-88417185', predicate: 'inputPrivacyKeyPhoneCall', params: [], type: 'InputPrivacyKey' },
		{ id: '1030105979', predicate: 'privacyKeyPhoneCall', params: [], type: 'PrivacyKey' },
		{ id: '-580219064', predicate: 'sendMessageGamePlayAction', params: [], type: 'SendMessageAction' },
		{ id: '-2048646399', predicate: 'phoneCallDiscardReasonMissed', params: [], type: 'PhoneCallDiscardReason' },
		{ id: '-527056480', predicate: 'phoneCallDiscardReasonDisconnect', params: [], type: 'PhoneCallDiscardReason' },
		{ id: '1471006352', predicate: 'phoneCallDiscardReasonHangup', params: [], type: 'PhoneCallDiscardReason' },
		{ id: '-84416311', predicate: 'phoneCallDiscardReasonBusy', params: [], type: 'PhoneCallDiscardReason' },
		{
			id: '1852826908',
		...
		{ id: '2104790276', predicate: 'dataJSON', params: [{ name: 'data', type: 'string' }], type: 'DataJSON' },
		{
			id: '-2095595325',
		...
		{ id: '1399245077', predicate: 'phoneCallEmpty', params: [{ name: 'id', type: 'long' }], type: 'PhoneCall' },
		{
			id: '462375633',
			predicate: 'phoneCallWaiting',
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'video', type: 'flags.5?true' },
				{ name: 'id', type: 'long' },
				{ name: 'access_hash', type: 'long' },
				{ name: 'date', type: 'int' },
				{ name: 'admin_id', type: 'int' },
		...
		{ id: '2054952868', predicate: 'inputMessagesFilterRoundVoice', params: [], type: 'MessagesFilter' },
		{ id: '-1253451181', predicate: 'inputMessagesFilterRoundVideo', params: [], type: 'MessagesFilter' },
		{ id: '-1997373508', predicate: 'sendMessageRecordRoundAction', params: [], type: 'SendMessageAction' },
		{
			id: '608050278',
		...
		},
		{
			...
			params: [
				...
				{ name: 'user_id', type: 'int' },
				{ name: 'inviter_id', type: 'flags.1?int' },
		...
		{ id: '511092620', predicate: 'topPeerCategoryPhoneCalls', params: [], type: 'TopPeerCategory' },
		{
			id: '-2143067670',
		...
		{ id: '1200788123', predicate: 'messageActionScreenshotTaken', params: [], type: 'MessageAction' },
		{
			id: '-1634752813',
		...
		{ id: '-1040652646', predicate: 'inputMessagesFilterMyMentions', params: [], type: 'MessagesFilter' },
		...
		{ id: '-419271411', predicate: 'inputMessagesFilterGeo', params: [], type: 'MessagesFilter' },
		{ id: '-530392189', predicate: 'inputMessagesFilterContacts', params: [], type: 'MessagesFilter' },
		{
			id: '1893427255',
		...
		{ id: '-1502174430', predicate: 'inputMessageID', params: [{ name: 'id', type: 'int' }], type: 'InputMessage' },
		{
			id: '-1160215659',
		...
		{ id: '-2037963464', predicate: 'inputMessagePinned', params: [], type: 'InputMessage' },
		{
			id: '-1687559349',
		...
		{ id: '-445792507', predicate: 'dialogPeer', params: [{ name: 'peer', type: 'Peer' }], type: 'DialogPeer' },
		{
			id: '223655517',
		...
		{ id: '-1658158621', predicate: 'secureValueTypePersonalDetails', params: [], type: 'SecureValueType' },
		{ id: '1034709504', predicate: 'secureValueTypePassport', params: [], type: 'SecureValueType' },
		{ id: '115615172', predicate: 'secureValueTypeDriverLicense', params: [], type: 'SecureValueType' },
		{ id: '-1596951477', predicate: 'secureValueTypeIdentityCard', params: [], type: 'SecureValueType' },
		{ id: '-1717268701', predicate: 'secureValueTypeInternalPassport', params: [], type: 'SecureValueType' },
		{ id: '-874308058', predicate: 'secureValueTypeAddress', params: [], type: 'SecureValueType' },
		{ id: '-63531698', predicate: 'secureValueTypeUtilityBill', params: [], type: 'SecureValueType' },
		{ id: '-1995211763', predicate: 'secureValueTypeBankStatement', params: [], type: 'SecureValueType' },
		{ id: '-1954007928', predicate: 'secureValueTypeRentalAgreement', params: [], type: 'SecureValueType' },
		{ id: '-1713143702', predicate: 'secureValueTypePassportRegistration', params: [], type: 'SecureValueType' },
		{ id: '-368907213', predicate: 'secureValueTypeTemporaryRegistration', params: [], type: 'SecureValueType' },
		{ id: '-1289704741', predicate: 'secureValueTypePhone', params: [], type: 'SecureValueType' },
		{ id: '-1908627474', predicate: 'secureValueTypeEmail', params: [], type: 'SecureValueType' },
		{
			id: '411017418',
		...
		{ id: '1722786150', predicate: 'help.deepLinkInfoEmpty', params: [], type: 'help.DeepLinkInfo' },
		{
			id: '1783556146',
		...
		{ id: '700340377', predicate: 'inputTakeoutFileLocation', params: [], type: 'InputFileLocation' },
		{
			id: '-513517117',
		...
		{ id: '-1255369827', predicate: 'contacts.topPeersDisabled', params: [], type: 'contacts.TopPeers' },
		{ id: '-1685456582', predicate: 'inputReportReasonCopyright', params: [], type: 'ReportReason' },
		{ id: '-732254058', predicate: 'passwordKdfAlgoUnknown', params: [], type: 'PasswordKdfAlgo' },
		{ id: '4883767', predicate: 'securePasswordKdfAlgoUnknown', params: [], type: 'SecurePasswordKdfAlgo' },
		{
			id: '-1141711456',
		...
		{ id: '-1736378792', predicate: 'inputCheckPasswordEmpty', params: [], type: 'InputCheckPasswordSRP' },
		{
			id: '-763367294',
		...
		{ id: '-1078332329', predicate: 'help.passportConfigNotModified', params: [], type: 'help.PassportConfig' },
		{
			id: '-1600596305',
		...
		{ id: '-952869270', predicate: 'jsonBool', params: [{ name: 'value', type: 'Bool' }], type: 'JSONValue' },
		{ id: '736157604', predicate: 'jsonNumber', params: [{ name: 'value', type: 'double' }], type: 'JSONValue' },
		{ id: '-1222740358', predicate: 'jsonString', params: [{ name: 'value', type: 'string' }], type: 'JSONValue' },
		{
			id: '-146520221',
			predicate: 'jsonArray',
		...
		{ id: '-1311015810', predicate: 'inputNotifyBroadcasts', params: [], type: 'InputNotifyPeer' },
		...
		{ id: '55281185', predicate: 'textMarked', params: [{ name: 'text', type: 'RichText' }], type: 'RichText' },
		{
			id: '483104362',
			predicate: 'textPhone',
		...
		{ id: '-610373422', predicate: 'inputPrivacyKeyPhoneP2P', params: [], type: 'InputPrivacyKey' },
		...
		{ id: '-202219658', predicate: 'messageActionContactSignUp', params: [], type: 'MessageAction' },
		{
			id: '-1398708869',
		...
		{ id: '112424539', predicate: 'inputMediaPoll', params: [{ name: 'poll', type: 'Poll' }], type: 'InputMedia' },
		{
			id: '1272375192',
		...
		{ id: '-264117680', predicate: 'chatOnlines', params: [{ name: 'onlines', type: 'int' }], type: 'ChatOnlines' },
		{ id: '1202287072', predicate: 'statsURL', params: [{ name: 'url', type: 'string' }], type: 'StatsURL' },
		{
			id: '-525288402',
		...
		{ id: '471437699', predicate: 'account.wallPapersNotModified', params: [], type: 'account.WallPapers' },
		{
			id: '1881892265',
		...
		{ id: '-1519029347', predicate: 'emojiURL', params: [{ name: 'url', type: 'string' }], type: 'EmojiURL' },
		{
			id: '-1275374751',
		...
		{ id: '-1529000952', predicate: 'inputPrivacyKeyForwards', params: [], type: 'InputPrivacyKey' },
		{ id: '1777096355', predicate: 'privacyKeyForwards', params: [], type: 'PrivacyKey' },
		{ id: '1461304012', predicate: 'inputPrivacyKeyProfilePhoto', params: [], type: 'InputPrivacyKey' },
		{ id: '-1777000467', predicate: 'privacyKeyProfilePhoto', params: [], type: 'PrivacyKey' },
		{
			id: '-1132476723',
		...
		{ id: '55761658', predicate: 'inputPrivacyKeyPhoneNumber', params: [], type: 'InputPrivacyKey' },
		{ id: '-778378131', predicate: 'privacyKeyPhoneNumber', params: [], type: 'PrivacyKey' },
		{ id: '-1472172887', predicate: 'topPeerCategoryForwardUsers', params: [], type: 'TopPeerCategory' },
		{ id: '-68239120', predicate: 'topPeerCategoryForwardChats', params: [], type: 'TopPeerCategory' },
		{
			id: '-1569748965',
		...
		{ id: '-1445536993', predicate: 'urlAuthResultDefault', params: [], type: 'UrlAuthResult' },
		{
			id: '1283572154',
		...
		{ id: '-1078612597', predicate: 'channelLocationEmpty', params: [], type: 'ChannelLocation' },
		{
			id: '547062491',
		...
		{ id: '-606798099', predicate: 'inputReportReasonGeoIrrelevant', params: [], type: 'ReportReason' },
		{
			id: '1401984889',
		...
		{ id: '42402760', predicate: 'inputStickerSetAnimatedEmoji', params: [], type: 'InputStickerSet' },
		{
			id: '967122427',
		...
		{ id: '-199313886', predicate: 'account.themesNotModified', params: [], type: 'account.Themes' },
		{
			id: '2137482273',
		...
		{ id: '-2112423005', predicate: 'updateTheme', params: [{ name: 'theme', type: 'Theme' }], type: 'Update' },
		{ id: '-786326563', predicate: 'inputPrivacyKeyAddedByPhone', params: [], type: 'InputPrivacyKey' },
		{ id: '1124062251', predicate: 'privacyKeyAddedByPhone', params: [], type: 'PrivacyKey' },
	],
	methods: [
		{
			id: '-878758099',
		...
		{ id: '1713919532', method: 'account.updateStatus', params: [{ name: 'offline', type: 'Bool' }], type: 'Bool' },
		{
			id: '-1430579357',
		...
		{ id: '858475004', method: 'contacts.block', params: [{ name: 'id', type: 'InputUser' }], type: 'Bool' },
		{ id: '-448724803', method: 'contacts.unblock', params: [{ name: 'id', type: 'InputUser' }], type: 'Bool' },
		{
			id: '-176409329',
		...
		{ id: '-661144474', method: 'auth.requestPasswordRecovery', params: [], type: 'auth.PasswordRecovery' },
		{
			id: '1319464594',
		...
		{ id: '-1080796745', method: 'invokeWithoutUpdates', params: [{ name: 'query', type: '!X' }], type: 'X' },
		{
			id: '234312524',
		...
		{ id: '405695855', method: 'account.getWebAuthorizations', params: [], type: 'account.WebAuthorizations' },
		{
			id: '755087855',
		...
		{ id: '749019089', method: 'help.getTermsOfServiceUpdate', params: [], type: 'help.TermsOfServiceUpdate' },
		{
			id: '-294455398',
		...
		{ id: '585256482', method: 'messages.getDialogUnreadMarks', params: [], type: 'Vector<DialogPeer>' },
		{
			id: '-2062238246',
		...
		{ id: '-1735311088', method: 'help.getAppConfig', params: [], type: 'JSONValue' },
		{
			id: '1862465352',
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'dark', type: 'flags.0?true' },
				{ name: 'format', type: 'flags.1?string' },
