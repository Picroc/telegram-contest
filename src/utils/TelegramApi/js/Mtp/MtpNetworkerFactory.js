    ...
    class MtpNetworker {
        ...
        performSheduledRequest = () => {
            ...
            if (this.pendingResends.length) {
                ...
                this.lastResendReq = {
                    req_msg_id: resendOpts.messageID, resend_msg_ids: resendMsgIDs
                };
            }
            ...
            if (messages.length > 1) {
                const container = new TLSerialization({
                    mtproto: true, startMaxLength: messagesByteLen + 64
                });
                    ...
                    (error) => {
                        ...
                        if (!error.message && !error.type) {
                            error = extend(baseError, {
                                type: 'NETWORK_BAD_REQUEST', originalError: error
                            });
                        }
            ...
            switch (message._) {
                ...
                case 'bad_msg_notification':
                    ...
                    if (message.error_code == 16 || message.error_code == 17) {
                        if (this.MtpTimeManager.applyServerTime(
